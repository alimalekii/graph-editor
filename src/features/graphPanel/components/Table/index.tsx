...
const CumulativeFilterTable = (props: ICumulativeFilterTableProps) => {
  ...
  return (
    <TableContainer className={`bdm-fitler-table ${className ? className : ''}`.trim()}>
      <Table stickyHeader className='bdm-fitler-table__table'>
        <TableHead className='bdm-fitler-table__head'>
          <TableRow className='bdm-fitler-table__head__row'>
            ...
            <TableCell align='center' className='bdm-fitler-table__head__row__cell'>
            ...
            <TableCell align='center' className='bdm-fitler-table__head__row__cell'>
              <Trans i18nKey='filter-box-advanced-formula' />
            </TableCell>
          </TableRow>
        </TableHead>
        ...
        <TableBody className='bdm-fitler-table__body'>
          {columns.map(row => (
            ...
            >
              ...
              {/* data cells */}
              <TableCell align='center' className='bdm-fitler-table__body__row__cell'>
